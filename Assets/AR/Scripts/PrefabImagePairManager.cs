...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class PrefabImagePairManager : MonoBehaviour, ISerializationCallbackReceiver
    {
        ...
        public void NextPrefab()
        {
            ...
            Destroy(active);
            active = Instantiate(arr[i], tracked.transform);
        }
        ...
        /// </summary>
        /// 
        public List<GameObject> arr = new();
        ...
        ARTrackedImage tracked;

        public void AssignPrefab(ARTrackedImage trackedImage)
        {
            var prefab = arr[i];
            active = Instantiate(prefab, trackedImage.transform);
        ...
        public void SetPrefaForReferenceImage(XRReferenceImage referenceImage, GameObject alternativePrefab)
        {
